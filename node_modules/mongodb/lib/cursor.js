...
var Cursor = function(bson, ns, cmd, options, topology, topologyOptions) {
  ...
  Object.defineProperty(this, 'sortValue', {
    enumerable:true,
    get: function() { return self.s.cmd.sort; }
  });

  // Add a read Only property
  Object.defineProperty(this, 'timeout', {
    enumerable:true,
    get: function() { return self.s.options.noCursorTimeout == true; }
  });

  // Get the read preferences
  Object.defineProperty(this, 'readPreference', {
    enumerable:true,
    get: function() { return self.s.options.readPreference; }
  });
}
...
// for(var name in Readable.prototype) {
//   Cursor.prototype[name] = Readable.prototype[name];
// }
