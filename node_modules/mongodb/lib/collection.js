...
var Collection = function(db, topology, dbName, name, pkFactory, options) {  
  ...
  Object.defineProperty(this, 'collectionName', {
    enumerable: true, get: function() { return self.s.name; }
  });

  Object.defineProperty(this, 'namespace', {
    enumerable: true, get: function() { return self.s.namespace; }
  });
  ...
  Object.defineProperty(this, "hint", {
      enumerable: true
    , get: function () { return self.s.collectionHint; }
    , set: function (v) { self.s.collectionHint = normalizeHintField(v); }
  });
}
...
Collection.prototype.options = function(callback) {
  ...
  this.s.db.listCollections(this.s.name, function(err, collections) {
    if(err) return handleCallback(callback, err);
